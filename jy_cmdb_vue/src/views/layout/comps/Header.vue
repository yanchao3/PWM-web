<template>
  <div style="background-color: #0d2a42; padding: 0px 20px; display: flex; align-items: center; justify-content: space-between; height: 80px">
        ...
        <li class="c_li">
          <el-dropdown style="">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item v-if="user_info.name">
    ...
    <el-dialog width="700px" title="重置密码" :visible.sync="is_visible_update_password">
      <el-form label-width="100px" style="margin-right: 50px" :rules="rules" ref="form_data" :model="form_data">
...
export default {
  ...
  methods: {
    ...
    on_submit_update_password() {
      ...
      console.log("tttttttt",this.form_data)
      master
        .post("user/update-password", this.form_data)
        .then(response => {
