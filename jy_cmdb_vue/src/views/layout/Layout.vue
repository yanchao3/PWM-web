<template>
  <section style="display: flex; flex-flow: column; height: 100%; min-width: 1300px; overflow: auto;background-color: #0d2a42;background: -webkit-linear-gradient(left, #0a4869 20%, #142c54 50%, #0a4869 80%);">
