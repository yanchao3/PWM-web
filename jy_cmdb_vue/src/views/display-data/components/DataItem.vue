<template>
  <ul style="white-space:nowrap; margin: 0px; padding: 0px">
    ...
    <li v-for="(value, key, index) in data" v-if="key[0]!='S'" :key="index" style="display: inline-block;  border:1px solid #E4E7ED; padding: 0 12px; font-size:14px; height: 40px; line-height: 40px" :style="{color: value==null ? '#C0C4CC':'#FFF'}">
      {{ value==null?'null':value }}
    </li>
    <!--<li style="display: inline-block;  border:1px solid #E4E7ED; padding: 9px">-->
      <!--<el-button style="padding: 0px" icon="el-icon-view" @click="on_show_detail(data)"></el-button>-->
      <!--&lt;!&ndash;<el-button style="padding: 0px" icon="el-icon-time" @click="on_show_history(data['_index'], data['_id'])"></el-button>&ndash;&gt;-->
      <!--&lt;!&ndash;<el-button style="padding: 0px" icon="el-icon-edit" @click="on_change_data(data)"></el-button>&ndash;&gt;-->
      <!--&lt;!&ndash;<el-button style="padding: 0px" icon="el-icon-delete" @click="on_delete()"></el-button>&ndash;&gt;-->
    <!--</li>-->
  </ul>
</template>
